...
<html>
	<head>
		...
		<title><g:message code="default.edit.label" args="['Kanban BO Role']" /></title>
	</head>
	<body>
		<a href="#edit-shiroRole" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		<div class="nav" role="navigation">
			<ul>
				<li><g:link class="list" action="list"><g:message code="default.list.label" args="['Backoffice User Role']" /></g:link></li>
		...
		<div id="edit-shiroRole" class="content scaffold-edit" role="main">
			<h1><g:message code="default.edit.label" args="['Backoffice User Role']" /></h1>
			...
			<g:form method="post" >
				...
				<fieldset class="buttons">
					...
					<g:if test="${!shiroRoleInstance.isAdmin()}">
